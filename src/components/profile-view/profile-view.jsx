...
export class ProfileView extends React.Component {
    ...
    getUser = (token) => {
        ...
        axios
            .get(`https://intense-ridge-76926.herokuapp.com/users/${Username}`, {
    ...
    editUser = (e) => {
        ...
        axios
            .put(
                `https://intense-ridge-76926.herokuapp.com/users/${Username}`,
                {
    ...
    onDeleteUser() {
        ...
        axios
            .delete(`https://intense-ridge-76926.herokuapp.com/users/${Username}`, {
                headers: { Authorization: `Bearer ${token}` },
            })
            .then((response) => {
                console.log(response);
